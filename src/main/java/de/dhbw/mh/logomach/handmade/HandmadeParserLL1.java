...
import static de.dhbw.mh.logomach.handmade.Token.Type.ASTERISK;
import static de.dhbw.mh.logomach.handmade.Token.Type.DIVIDE;
import static de.dhbw.mh.logomach.handmade.Token.Type.EOF;
import static de.dhbw.mh.logomach.handmade.Token.Type.EQUAL;
import static de.dhbw.mh.logomach.handmade.Token.Type.FALSE;
import static de.dhbw.mh.logomach.handmade.Token.Type.GREATER;
import static de.dhbw.mh.logomach.handmade.Token.Type.GREATER_EQUAL;
import static de.dhbw.mh.logomach.handmade.Token.Type.IDENTIFIER;
import static de.dhbw.mh.logomach.handmade.Token.Type.LAND;
import static de.dhbw.mh.logomach.handmade.Token.Type.LESS;
import static de.dhbw.mh.logomach.handmade.Token.Type.LESS_EQUAL;
import static de.dhbw.mh.logomach.handmade.Token.Type.LOR;
import static de.dhbw.mh.logomach.handmade.Token.Type.LPAREN;
import static de.dhbw.mh.logomach.handmade.Token.Type.MINUS;
import static de.dhbw.mh.logomach.handmade.Token.Type.MODULO;
import static de.dhbw.mh.logomach.handmade.Token.Type.NOT_EQUAL;
import static de.dhbw.mh.logomach.handmade.Token.Type.NUMERIC_LITERAL;
import static de.dhbw.mh.logomach.handmade.Token.Type.PLUS;
import static de.dhbw.mh.logomach.handmade.Token.Type.POWER;
import static de.dhbw.mh.logomach.handmade.Token.Type.RPAREN;
import static de.dhbw.mh.logomach.handmade.Token.Type.TRUE;
...
import de.dhbw.mh.logomach.ast.AstUnaryOperation;
